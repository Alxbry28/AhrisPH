                              ...
                              <table class="table align-items-center table-flush table-hover">
                                ...
                                <tbody>
                                  <tr>
                                    <th>
                                      <div class="custom-control custom-checkbox">
                                        <input class="custom-control-input" id="table-check" type="checkbox">
                                        <label class="custom-control-label" for="table-check"></label>
                                      </div>
                                    </th>
                                    <td class="table-user">
                                      <b>John Michael</b>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav mb-3" id="tabs_3" role="tablist">
                                  <li class="nav-item">
                                    <a class="nav-link" id="first-tab" data-toggle="tab" href="#business" role="tab" aria-selected="true">
                                  ...
                                  <li class="nav-item">
                                    <a class="nav-link" id="first-tab" data-toggle="tab" href="#individual" role="tab" aria-selected="">
                                        <div class="custom-control custom-radio mb-3">
